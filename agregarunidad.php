...
if ($_SERVER['REQUEST_METHOD'] =='POST' ) {
	...
	if (empty($nombre)) {
		...
		$statement = $conexion->prepare('SELECT	* FROM unidad WHERE unidad =:nombre LIMIT 1 ');
		...
		$statement = $conexion->prepare('INSERT INTO unidad 
			(idunidad,unidad,usuarios_idusuarios) 
		...
		$resultado = $statement->fetch();
			...
			$agregado .='<li>La Unidad se a agregado</li>';
...
require 'views/agregarunidad.view.php';
